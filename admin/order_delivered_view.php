...
<td></td><td></td><td></td><td><a href="order_cancel.php?cancel_id=<?php echo $view_id; ?>"><button class="btn btn-xs btn-danger" id="<?php echo $result['o_srl_no']; ?>" onclick="pdelivery(this.id)">Cancel</button></a></td>
                                </table>
                            </div>
                        </div>
                    </div>
