...
<?php 
  ...
  $view_cancel_id = $_GET['view_cancel_id'];

  //Session::set("view_id", $view_id);
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                      <td colspan="2">
                                        <table>
<?php 
    $queryy = "SELECT tbl_order.*, tbl_customer_acc.*, tbl_deleivery_address.* FROM tbl_order LEFT JOIN tbl_customer_acc ON tbl_order.o_cstmr_id=tbl_customer_acc.cstmr_srl_no LEFT JOIN tbl_deleivery_address ON tbl_deleivery_address.deliver_serial_no=tbl_order.o_delivery_id WHERE o_srl_no='$view_cancel_id' ";
...
?>
    ...
    <?php 
      ...
      $deliveryCharge = 50;
      $otherCost = 0;
      $query = "SELECT tbl_order_detail.*, tbl_order.*, tbl_product.* FROM tbl_order_detail LEFT JOIN tbl_order ON tbl_order_detail.o_d_srl_no=tbl_order.o_srl_no LEFT JOIN tbl_product ON tbl_product.p_srl_no=tbl_order_detail.o_d_product_id WHERE tbl_order_detail.o_d_id='$view_cancel_id'";
...
<td></td><td></td><td></td><td>
                                          <a href="transfer_to_pending_orders.php?undo_id=<?php echo $resullt['o_srl_no']; ?>"><button class="btn btn-xs btn-danger" >Undo</button></a>
                                        </td>
                                </table>
                            </div>
                        </div>
