...
<div class="row">
    ...
    <!--Pagination-->  
    <?php 
      $query = "SELECT * FROM tbl_order WHERE o_status='A' order by o_srl_no DESC";
    ...
    ?>   
                                    <tr>
                                        ...
                                        <td><a href="order_delivered_view.php?view_id=<?php echo $result['o_srl_no']; ?>"><button class="btn btn-xs btn-danger" id="<?php echo $result['o_srl_no']; ?>" onclick="view(this.id)">view</button></a> </td>  
