        ...
        $totalquantity = 0;
            ...
            if ($Cart_slt) {
              while ( $result = $Cart_slt->fetch_assoc()) {
                ...
                $totalcost = $totalcost+($result['p_offer_price']*$result['quantity']);
...
?>          
            ...
            <td style="width: 25%; text-align: center; font-weight: normal;font-size: 10px; text-align: center;"><?php echo $result['p_offer_price']*$result['quantity']; ?> Tk</td>
          </tr>
